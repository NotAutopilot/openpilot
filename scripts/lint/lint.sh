...
IGNORED_FILES="uv\.lock|docs\/CARS.md|scripts\/nap\/firmware\/.*\.bin|system\/hardware\/tici\/updater_magic"
IGNORED_DIRS="^third_party.*|^c3_third_party.*|^msgq.*|^msgq_repo.*|^opendbc.*|^opendbc_repo.*|^cereal.*|^panda.*|^rednose.*|^rednose_repo.*|^tinygrad.*|^tinygrad_repo.*|^teleoprtc.*|^teleoprtc_repo.*"
