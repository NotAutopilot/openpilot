...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"NAPAdjustAccWithSpeedLimit", {PERSISTENT, BOOL}},
    {"NAPAutoresumeAcc", {PERSISTENT, BOOL}},
    {"NAPBrakeFactor", {PERSISTENT, FLOAT, "1.0"}},
    {"NAPDisableCruiseControl", {PERSISTENT, BOOL}},
    {"NAPEnableJustCC", {PERSISTENT, BOOL}},
    ...
    {"NAPSpeedLimitOffset", {PERSISTENT, FLOAT, "0.0"}},
    {"NAPSpeedLimitUseRelative", {PERSISTENT, BOOL}},
    {"NAPUseLongControlData", {PERSISTENT, BOOL}},
